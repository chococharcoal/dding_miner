...
export const FARMING_RECIPES = {
  ...
  TRI_ICECREAM: {
    name:'삼색 아이스크림', grade:'normal', currentPrice:2341,
  ...
  ROAST_CHICKEN_PIE: {
    name:'로스트 치킨 파이', grade:'normal', currentPrice:1720,
  ...
  SWEET_CHICKEN_BURGER: {
    name:'스윗 치킨 햄버거', grade:'rare', currentPrice:2921,
  ...
  TOMATO_PINEAPPLE_PIZZA: {
    name:'토마토 파인애플 피자', grade:'rare', currentPrice:2681,
  ...
  ONION_SOUP: {
    name:'양파 수프', grade:'rare', currentPrice:1416,
  ...
  HERB_PORK_BELLY_STEAM: {
    name:'허브 삼겹살 찜', grade:'rare', currentPrice:1445,
  ...
  /* ── 에픽 ── */
  TOMATO_LASAGNA: {
    name:'토마토 라자냐', grade:'epic', currentPrice:1891,
  ...
  DEEP_CREAM_PANE: {
    name:'딥 크림 빠네', grade:'epic', currentPrice:3383,
  ...
  TRIPLE_BEEF_RIB_SKEWER: {
    name:'트리플 소갈비 꼬치', grade:'epic', currentPrice:3998,
