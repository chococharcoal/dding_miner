...
export const ALCHEMY = {
  ...
  essence_guardian1: { name:'수호의 정수 ★',   tier:1, type:'essence', seafood:'oyster',  output:2, color:'#3d6fd4',
    materials:{ oyster1:2, clay:2 } },
  essence_wave1:     { name:'파동의 정수 ★',   tier:1, type:'essence', seafood:'conch',   output:2, color:'#c89c00',
    materials:{ conch1:2, sand:4 } },
  essence_chaos1:    { name:'혼란의 정수 ★',   tier:1, type:'essence', seafood:'octopus', output:2, color:'#7c52c8',
    materials:{ octopus1:2, dirt:8 } },
  essence_life1:     { name:'생명의 정수 ★',   tier:1, type:'essence', seafood:'seaweed', output:2, color:'#d94f3d',
    materials:{ seaweed1:2, gravel:4 } },
  essence_corrosion1:{ name:'부식의 정수 ★',   tier:1, type:'essence', seafood:'urchin',  output:2, color:'#3a9e68',
    materials:{ urchin1:2, granite:2 } },

  /* ── 1차: 핵 (정수 2종 + 회) → 1개 생산 ── */
  core_guard:     { name:'물결 수호의 핵 ★',  tier:1, type:'compound', output:1, color:'#3d6fd4',
    materials:{ essence_guardian1:1, essence_wave1:1, shrimp:1 } },
  core_wave:      { name:'파동 오염의 핵 ★',  tier:1, type:'compound', output:1, color:'#c89c00',
    materials:{ essence_wave1:1, essence_chaos1:1, sea_bream:1 } },
  core_chaos:     { name:'질서 파괴의 핵 ★',  tier:1, type:'compound', output:1, color:'#7c52c8',
    materials:{ essence_chaos1:1, essence_life1:1, herring:1 } },
  core_life:      { name:'활력 붕괴의 핵 ★',  tier:1, type:'compound', output:1, color:'#d94f3d',
    materials:{ essence_life1:1, essence_corrosion1:1, goldfish:1 } },
  core_corrosion: { name:'침식 방어의 핵 ★',  tier:1, type:'compound', output:1, color:'#3a9e68',
    materials:{ essence_corrosion1:1, essence_guardian1:1, bass:1 } },

  /* ── 2차: 에센스 (어패류 2개 + 해초6 + 잎6) → 2개 생산 ── */
  essence_guardian2: { name:'수호 에센스 ★★',  tier:2, type:'essence', seafood:'oyster',  output:2, color:'#3d6fd4',
    materials:{ oyster2:2, kelp:6, oak_leaf:6 } },
  essence_wave2:     { name:'파동 에센스 ★★',  tier:2, type:'essence', seafood:'conch',   output:2, color:'#c89c00',
    materials:{ conch2:2, kelp:6, spruce_leaf:6 } },
  essence_chaos2:    { name:'혼란 에센스 ★★',  tier:2, type:'essence', seafood:'octopus', output:2, color:'#7c52c8',
    materials:{ octopus2:2, kelp:6, birch_leaf:6 } },
  essence_life2:     { name:'생명 에센스 ★★',  tier:2, type:'essence', seafood:'seaweed', output:2, color:'#d94f3d',
    materials:{ seaweed2:2, kelp:6, cherry_leaf:6 } },
  essence_corrosion2:{ name:'부식 에센스 ★★',  tier:2, type:'essence', seafood:'urchin',  output:2, color:'#3a9e68',
    materials:{ urchin2:2, kelp:6, dark_oak_leaf:6 } },

  /* ── 2차: 결정 (에센스 2종 + 켈프8 + 바닐라) → 1개 생산 ── */
  crystal_vitality: { name:'활기 보존의 결정 ★★', tier:2, type:'compound', output:1, color:'#3d6fd4',
    materials:{ essence_guardian2:1, essence_life2:1, kelp:8, lapis_block:1 } },
  crystal_erosion:  { name:'파도 침식의 결정 ★★', tier:2, type:'compound', output:1, color:'#c89c00',
    materials:{ essence_wave2:1, essence_corrosion2:1, kelp:8, redstone_block:1 } },
  crystal_defense:  { name:'방어 오염의 결정 ★★', tier:2, type:'compound', output:1, color:'#7c52c8',
    materials:{ essence_chaos2:1, essence_guardian2:1, kelp:8, iron_ingot:3 } },
  crystal_torrent:  { name:'격류 재생의 결정 ★★', tier:2, type:'compound', output:1, color:'#d94f3d',
    materials:{ essence_life2:1, essence_wave2:1, kelp:8, gold_ingot:2 } },
  crystal_poison:   { name:'맹독 혼란의 결정 ★★', tier:2, type:'compound', output:1, color:'#3a9e68',
    materials:{ essence_corrosion2:1, essence_chaos2:1, kelp:8, diamond:1 } },

  /* ── 3차: 엘릭서 (어패류 1개 + 불우렁쉥이2 + 유리병3 + 바닐라) → 1개 생산 ── */
  elixir_guardian: { name:'수호의 엘릭서 ★★★', tier:3, type:'essence', seafood:'oyster',  output:1, color:'#3d6fd4',
    materials:{ oyster3:1, firn:2, glass_bottle:3, netherrack:8 } },
  elixir_wave:     { name:'파동의 엘릭서 ★★★', tier:3, type:'essence', seafood:'conch',   output:1, color:'#c89c00',
    materials:{ conch3:1, firn:2, glass_bottle:3, magma:4 } },
  elixir_chaos:    { name:'혼란의 엘릭서 ★★★', tier:3, type:'essence', seafood:'octopus', output:1, color:'#7c52c8',
    materials:{ octopus3:1, firn:2, glass_bottle:3, soul_soil:4 } },
  elixir_life:     { name:'생명의 엘릭서 ★★★', tier:3, type:'essence', seafood:'seaweed', output:1, color:'#d94f3d',
    materials:{ seaweed3:1, firn:2, glass_bottle:3, crimson_stem:4 } },
  elixir_corrosion:{ name:'부식의 엘릭서 ★★★', tier:3, type:'essence', seafood:'urchin',  output:1, color:'#3a9e68',
    materials:{ urchin3:1, firn:2, glass_bottle:3, warped_stem:4 } },

  /* ── 3차: 영약 (엘릭서 2종 + 켈프12 + 발광열매4 + 죽은산호2) → 1개 생산 ── */
  potion_immortal: { name:'불멸 재생의 영약 ★★★', tier:3, type:'compound', output:1, color:'#3d6fd4',
    materials:{ elixir_guardian:1, elixir_life:1, kelp:12, glowberry:4, coral_dead_tube:2 } },
  potion_barrier:  { name:'파동 장벽의 영약 ★★★', tier:3, type:'compound', output:1, color:'#c89c00',
    materials:{ elixir_wave:1, elixir_guardian:1, kelp:12, glowberry:4, coral_dead_brain:2 } },
  potion_corrupt:  { name:'타락 침식의 영약 ★★★', tier:3, type:'compound', output:1, color:'#7c52c8',
    materials:{ elixir_chaos:1, elixir_corrosion:1, kelp:12, glowberry:4, coral_dead_bubble:2 } },
  potion_frenzy:   { name:'생명 광란의 영약 ★★★', tier:3, type:'compound', output:1, color:'#d94f3d',
    materials:{ elixir_life:1, elixir_chaos:1, kelp:12, glowberry:4, coral_dead_fire:2 } },
  potion_venom:    { name:'맹독 파동의 영약 ★★★', tier:3, type:'compound', output:1, color:'#3a9e68',
